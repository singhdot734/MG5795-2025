...
## Start Here
We'll begin by initializing the environment to make sure all dependencies are present and data objects 
are loaded. Click the run button on the setup section below. 
